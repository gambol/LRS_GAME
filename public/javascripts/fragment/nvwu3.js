...
buf.push("<div class=\"all\"><div class=\"one\"><!--头像--><div class=\"left\"><img" + (jade.attr("src", '' + (user.touXiang) + '', true, false)) + "/></div><!--座位号--><div class=\"righttop\">" + (jade.escape((jade_interp = user.zuoWei) == null ? '' : jade_interp)) + "</div><!--会员名--><div class=\"rightbottom\">" + (jade.escape((jade_interp = user.huiYuan) == null ? '' : jade_interp)) + "</div></div><div class=\"two\"><!--向下大拇指图标--><div class=\"tubiao\"><img src=\"/pictures/damuzhixia.png\"/></div><!--.zi--><!--    | 毒--></div></div>");
    }
