...
jade.templates['yuyanjia2'] = (function(){
...
buf.push("<div class=\"all\"><div class=\"one\"><!--头像--><div class=\"left\"><img" + (jade.attr("src", '' + (user.touXiang) + '', true, false)) + "/></div><!--座位号--><div class=\"righttop\">" + (jade.escape((jade_interp = user.zuoWei) == null ? '' : jade_interp)) + "</div><!--会员名--><div class=\"rightbottom\">" + (jade.escape((jade_interp = user.huiYuan) == null ? '' : jade_interp)) + "</div></div>");
if ( user.shenFen)
{
buf.push("<div class=\"two\"><!--身份图片--><img" + (jade.attr("src", '' + (user.shenFen) + '', true, false)) + "/></div>");
}
buf.push("</div>");
    }
